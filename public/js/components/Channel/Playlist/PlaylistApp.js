  ...
  render: function() {
    return(
      React.createElement("div", null,
        React.createElement(PlaylistControl, {ref: "playlistControl", disabled: this.state.disableInput, inputError: this.state.inputError, handleInput: this.handleInput}),
        React.createElement(Playlist, {ref: "playlist", playItem: this.props.playItem})
      )
    );
  }
});